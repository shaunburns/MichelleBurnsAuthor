  ...
  return (
    <Layout title="About" description="About Me" wrapperClassName={styles.aboutLayout}>
      <div
        ...
        <p>
          Through her writing, Michelle aims to craft compelling worlds, memorable characters, and meaningful stories that resonate with fantasy readers while honoring the genre that first ignited her imagination.
        </p>
      </div>
    </Layout>
  );
